 ...
 * Generated: 2026-07-20T15:43:11.677Z
 */

import { matchaIconRegistry } from './icons';
/**
 * perfect-six theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { perfectSixTheme } from './perfect-six';
 *   import './perfect-six.css';
 */
export const perfectSixTheme = {
  name: 'perfect-six',
  __built: true,
  tokens: {
    ...
    "--font-family-heading": "Georgia, Georgia, \"Times New Roman\", Times, serif",
    ...
    "--color-accent": "light-dark(#173F35, #C7D8C8)",
    "--color-accent-muted": "light-dark(#173F3514, #C7D8C820)",
    "--color-neutral": "light-dark(#4B3D300F, #E9DFC91A)",
    "--color-background-surface": "light-dark(#FFFDF7, #20221D)",
    "--color-background-body": "light-dark(#F3EBDD, #151813)",
    "--color-overlay": "light-dark(#173F3580, #0D100DCC)",
    "--color-overlay-hover": "light-dark(#173F350D, #C7D8C80D)",
    "--color-overlay-pressed": "light-dark(#173F351A, #C7D8C81A)",
    "--color-background-muted": "light-dark(#E9DFC9, #2B3129)",
    "--color-text-primary": "light-dark(#2B251E, #F2EBDD)",
    "--color-text-secondary": "light-dark(#6D6255, #BDB5A5)",
    "--color-text-disabled": "light-dark(#A69C8D, #6F746B)",
    "--color-text-accent": "light-dark(#173F35, #C7D8C8)",
    "--color-on-dark": "#FFFDF7",
    "--color-on-light": "#2B251E",
    "--color-on-accent": "light-dark(#FFFDF7, #173F35)",
    "--color-on-success": "light-dark(#FFFDF7, #173F35)",
    "--color-on-error": "light-dark(#FFFDF7, #2B251E)",
    "--color-on-warning": "light-dark(#2B251E, #2B251E)",
    "--color-icon-accent": "light-dark(#173F35, #C7D8C8)",
    "--color-icon-primary": "light-dark(#2B251E, #F2EBDD)",
    "--color-icon-secondary": "light-dark(#6D6255, #BDB5A5)",
    "--color-icon-disabled": "light-dark(#A69C8D, #6F746B)",
    "--color-background-card": "light-dark(#FFFDF7, #20221D)",
    "--color-background-popover": "light-dark(#FFFDF7, #2B3129)",
    "--color-background-inverted": "light-dark(#173F35, #C7D8C8)",
    "--color-success": "light-dark(#4D9900, #6dbf2a)",
    "--color-success-muted": "light-dark(#4D990020, #6dbf2a20)",
    "--color-error": "light-dark(#7A2E2E, #D7867B)",
    "--color-error-muted": "light-dark(#7A2E2E20, #D7867B20)",
    "--color-warning": "light-dark(#FFB600, #ffc940)",
    "--color-warning-muted": "light-dark(#FFB60020, #ffc94020)",
    "--color-border": "light-dark(#D8CCB8, #E9DFC91A)",
    "--color-border-emphasized": "light-dark(#B7A992, #6F746B)",
